...
Cypress.Commands.add("importMetamaskWallet", (secretWords, password) => {
  return cy.task("importMetamaskWallet", { secretWords, password });
});

Cypress.Commands.add("importMetaMaskWalletUsingPrivateKey", (key) => {
...
Cypress.Commands.add("changeAccount", (number) => {
